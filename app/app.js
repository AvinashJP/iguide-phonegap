...
App = Ext.regApplication({
    ...
    FB_RedirectUrl : 'http://www.iguidedublin.mobi/HTML5/index.html',
    ...
    debug : false,
    onlineImageFolder : 'http://www.iguidedublin.mobi/WEBFILES/',
    offlineImage : 'resources/images/avatar.jpg',
    dataUrl : 'data/initialb.php.min.xml?xu=iguide&xp=iguide&seq=initialb&tname=initialb&langprefix=eng',//'../../xml/initialb.php?xu=iguide&xp=iguide&seq=initialb&tname=initialb&langprefix=eng',
    updateUrl : 'data/updateb.php.xml?xu=iguide&xp=iguide&tname=updateb&langprefix=eng&seq=',//'../../xml/updateb.php?xu=iguide&xp=iguide&tname=updateb&langprefix=eng&seq=',
